...
public class Constants {
	...
	public static AutoPlan kAutoPlan;
	...
	public static int kDriveLeftMasterPort;
	public static int kDriveLeftSlavePort;
	public static int kDriveRightMasterPort;
	public static int kDriveRightSlavePort;
